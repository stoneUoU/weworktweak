...
@class CALayer, NSString, UIButton, UIImageView, UILabel, UIView, WWDashLineView, WXCAppStoreView;
...
- (struct CGRect)layoutHeaderView;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;
- (void)layoutSubviews;
- (void)setContent:(unsigned long long)arg1 tipsWording:(id)arg2 summaryWording:(id)arg3 hongbaoType:(unsigned int)arg4 hongbaoId:(id)arg5 infoWording:(id)arg6 wishingWording:(id)arg7;
