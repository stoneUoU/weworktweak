...
@class NSString, UIButton, UIScrollView, UIView, WWKCardPrivacySettingViewController;

@interface WWKBaseLayeredCardViewController : UIViewController <WWKCardPrivacySettingViewControllerDelegate, UIScrollViewDelegate>
{
    _Bool _simulateBlur;
    _Bool _appeared;
    _Bool _dismissed;
    _Bool _privacyAnimating;
    WWKCardPrivacySettingViewController *_privacySettingViewController;
...
@property(nonatomic) _Bool privacyAnimating; // @synthesize privacyAnimating=_privacyAnimating;
...
@property(retain, nonatomic) WWKCardPrivacySettingViewController *privacySettingViewController; // @synthesize privacySettingViewController=_privacySettingViewController;
- (void).cxx_destruct;
