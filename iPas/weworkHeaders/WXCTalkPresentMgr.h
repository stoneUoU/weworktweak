...
@interface WXCTalkPresentMgr : MMService <MMService>
{
    ...
    NSMutableDictionary *_deleteGroupIdDic;
...
+ (int)getInviteUuidFromMemberList:(id)arg1;
+ (id)genFakeVoiceGroupMemWithUuid:(int)arg1 inviteUuid:(int)arg2 memberSession:(int)arg3;
...
@property(retain, nonatomic) NSMutableDictionary *deleteGroupIdDic; // @synthesize deleteGroupIdDic=_deleteGroupIdDic;
...
- (void)saveDeleteRoomGroupIdCache;
- (void)recoverGroupIdIfDelete:(id)arg1;
- (void)markAllRoomDataDeleted;
- (void)markRoomDataDeleted:(id)arg1;
- (_Bool)isRoomDataDeleted:(id)arg1;
...
- (void)onMemberChange:(id)arg1 memberChangeType:(int)arg2 needUpdateProfile:(_Bool)arg3 serverTime:(double)arg4 msgFromType:(int)arg5;
- (void)notifyRoomCreate:(id)arg1;
- (void)notifyRoomInfoChange;
- (void)updateTalkRoomGroupInfo:(id)arg1 serverGroupId:(id)arg2;
- (void)notifyHasIncomingMutilTalk:(id)arg1 msgFromType:(int)arg2;
