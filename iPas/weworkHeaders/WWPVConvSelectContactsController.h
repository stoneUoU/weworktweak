...
@protocol WWPVConvSelectContactsControllerDelegate;

@interface WWPVConvSelectContactsController : UIViewController <UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, WWKSelectContactsBottomBarDelegate>
{
    ...
    id <WWPVConvSelectContactsControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <WWPVConvSelectContactsControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (id).cxx_construct;
- (void).cxx_destruct;
...
- (void)dealloc;
- (void)viewDidLoad;
- (id)initWithUsers:(const vector_89e6321f *)arg1;
