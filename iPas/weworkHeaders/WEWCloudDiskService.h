...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)onFinished:(_Bool)arg1 withOriginalObject:(const shared_ptr_299d422b *)arg2 isSuccess:(_Bool)arg3 updateObj:(const shared_ptr_299d422b *)arg4;
...
- (_Bool)isObjectInfoDownload:(id)arg1;
- (_Bool)DeleteCommentOfCloudDiskObject:(id)arg1 commentId:(unsigned long long)arg2 withCallback:(CDUnknownBlockType)arg3;
- (_Bool)addCommentToCloudDiskObject:(id)arg1 commentInfo:(id)arg2 withCallback:(CDUnknownBlockType)arg3;
...
- (_Bool)reUploadFileToFolder:(id)arg1 toFolder:(id)arg2 withCallback:(CDUnknownBlockType)arg3;
...
- (void)getCloudDiskObjectEntries:(id)arg1 forldId:(id)arg2 withSortType:(unsigned long long)arg3 needGetLastData:(_Bool)arg4 dataCallback:(CDUnknownBlockType)arg5;
