...
@interface WWKCloudDiskAssistViewController : UIViewController <ConversationProxyObserverDelegate, WWKApprovalTableViewCellDelegate, UITableViewDataSource, UITableViewDelegate, WWYunPanNotificationCellDelegate>
{
...
- (void)ww_getAssistMessageFromMessage:(scoped_refptr_c1fa851d)arg1;
