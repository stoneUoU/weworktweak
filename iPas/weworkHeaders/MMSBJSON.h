...
#import "MMSBJSONBase.h"

#import "MMSBJSONParser-Protocol.h"
#import "MMSBJSONWriter-Protocol.h"

@class MMSBJSONParser, MMSBJSONWriter;

@interface MMSBJSON : MMSBJSONBase <MMSBJSONParser, MMSBJSONWriter>
{
    MMSBJSONParser *jsonParser;
    MMSBJSONWriter *jsonWriter;
}
