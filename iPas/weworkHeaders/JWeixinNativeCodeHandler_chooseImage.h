...
@interface JWeixinNativeCodeHandler_chooseImage : NativeCodeHandlerBase <WWKAssetGroupsControllerDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>
{
    _Bool _sizeOriginal;
