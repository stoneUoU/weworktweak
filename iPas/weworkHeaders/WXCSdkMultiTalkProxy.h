...
@class NSMutableDictionary, NSMutableSet, NSString, WXCPbPVMergeWWMember;
...
@interface WXCSdkMultiTalkProxy : NSObject <IWXTalkExt, IWXCRecordPermissionCheckExt, IWXCLivePlayExt, ICameraPermissionCheckExt, ITalkMultiVideoExt, IWXCLiveRoomExt>
{
    int _enterTalkType;
    int _mMultiTalkMode;
    unsigned int _mCorpVoipMaxSize;
...
@property(nonatomic) unsigned int mCorpVoipMaxSize; // @synthesize mCorpVoipMaxSize=_mCorpVoipMaxSize;
...
- (_Bool)createPvMergeTalk:(id)arg1;
...
- (_Bool)stopMultiTalk;
- (void)startMultiTalk:(id)arg1 isGuest:(_Bool)arg2 title:(id)arg3 voiceType:(int)arg4;
- (void)dealloc;
- (id)init;
