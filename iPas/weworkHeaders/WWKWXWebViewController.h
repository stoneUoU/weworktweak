...
@class JWeixinOpenAPILogicImpl, NSMutableDictionary, NSSet, NSString, UILongPressGestureRecognizer, WWKApiSSOHandler, WWKWebBannerView, WebviewJSVoiceHelper;

@interface WWKWXWebViewController : WWKWebBrowserController <UIWebViewDelegate>
{
    _Bool _hasShowContinueVisit;
    _Bool _hasRemovedWeixinUA;
    ...
    NSString *_lastUserActionURL;
    NSString *_lastOpenWXQQSTVIDUrl;
    UILongPressGestureRecognizer *_longPressGestureRecognizer;
}

@property(retain, nonatomic) UILongPressGestureRecognizer *longPressGestureRecognizer; // @synthesize longPressGestureRecognizer=_longPressGestureRecognizer;
@property(retain, nonatomic) NSString *lastOpenWXQQSTVIDUrl; // @synthesize lastOpenWXQQSTVIDUrl=_lastOpenWXQQSTVIDUrl;
@property(retain, nonatomic) NSString *lastUserActionURL; // @synthesize lastUserActionURL=_lastUserActionURL;
...
@property(nonatomic) _Bool hasRemovedWeixinUA; // @synthesize hasRemovedWeixinUA=_hasRemovedWeixinUA;
...
- (void)evaluationExtraJavaScript:(id)arg1;
