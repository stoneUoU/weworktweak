...
#import "WWCMROCRProcessorDelegate-Protocol.h"
...
@interface WWQRAndVCardScanViewController : UIViewController <WWCMROCRProcessorDelegate, WWKLoginConnectViewControllerDelegate, AVCaptureVideoDataOutputSampleBufferDelegate, UIImagePickerControllerDelegate>
{
    scoped_ptr_cf303027 scanImage;
    struct QBar *qbarLib;
    _Bool _tryingQBar;
...
- (scoped_ptr_cf303027)p_cropSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 fromRect:(struct CGRect)arg2 outWidth:(int *)arg3 outHeight:(int *)arg4;
