...
@class AppRootControllerProcess, CXProvider, NSMutableArray, NSString, NSUUID, TencentOAuth, UIWindow;
...
- (void)p_activeTryToShowInstanceCheckin;
- (void)p_notifyShowInstanceCheckin;
...
- (void)handleReceiveNotificationWithRoomID:(unsigned long long)arg1 senderID:(unsigned long long)arg2 mailTips:(struct NewMailTips *)arg3 msgContentType:(long long)arg4 convType:(long long)arg5;
...
- (void)detectPasteboardChange:(id)arg1;
