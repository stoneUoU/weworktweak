...
@class NSString, QMUITextView, UILabel;

@interface WWCardWallEditingCommentCell : WWCardWallCell <UITextFieldDelegate, QMUITextViewDelegate>
{
    _Bool _isEditingMode;
    _Bool _isLastCell;
    _Bool _isShowKey;
    _Bool _isInMyEditingMode;
    UILabel *_keyLabel;
    UILabel *_commentLable;
    UILabel *_commentUser;
    QMUITextView *_textView;
    long long _valueType;
}

@property(nonatomic, setter=setInMyEditingMode:) _Bool isInMyEditingMode; // @synthesize isInMyEditingMode=_isInMyEditingMode;
@property(nonatomic, setter=setShowKey:) _Bool isShowKey; // @synthesize isShowKey=_isShowKey;
...
@property(retain, nonatomic) UILabel *commentUser; // @synthesize commentUser=_commentUser;
